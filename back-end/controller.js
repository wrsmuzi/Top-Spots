...
class Controller {
    ...
    creatingJwtToken = async (evtoken_id) =>{
        const userInf = await supabase.query(`SELECT username, email  FROM "Users" WHERE evtoken_id = $1`,[evtoken_id]);
    ...
    emailVerify = async (req, res) =>{
        try{
            ...
            const isVerified = await supabase.query(`UPDATE "Users" SET is_verified = true WHERE evtoken_id = $1 RETURNING is_verified`,[chekedTokenId])
